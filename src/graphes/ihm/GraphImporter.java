...
public class GraphImporter {
	...
	public static boolean comparer(String fichierGraphe, String fichierReponse, IPCC algo)
		...
		try {
			...
			System.out.println("pas de chemin entre " + df.getSource() + " et " + df.getDestination() + "\n");
			return ("pas de chemin entre " + df.getSource() + " et " + df.getDestination()).equals(sb.toString());
		}

		catch(ArcNegatifEx a){
			System.out.println("Le graphe ne doit pas contenir de valuation négative");
			return true;
		}

		catch(CircuitEx c) {
			System.out.println("Le graphe ne doit pas contenir de circuit");
			return true;
		}
